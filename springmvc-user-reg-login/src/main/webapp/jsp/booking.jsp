...
<body>
	...
	<label >Customer Id</label><form:input  type="number" path="CustomerId" value="" readonly="true"/><br>
	<label >Email Id</label><form:input  type="number" path="customerEmailId" value="" readonly="true"/><br>
